...
public class Bishop : Piece
{
    ...
    public override List<Square> GetPossibleMoveTurns(Square squareWithThis)
    {
        ...
        Vector2Int upDir = new Vector2Int(1, 1);
        Vector2Int downDir = new Vector2Int(1, -1);
        Vector2Int rightDir = new Vector2Int(-1, 1);
        Vector2Int leftDir = new Vector2Int(-1, -1);

        AddPossibleTurnsInDiagonal(turns, squareWithThis.Coordinates, upDir);
        AddPossibleTurnsInDiagonal(turns, squareWithThis.Coordinates, downDir);
        AddPossibleTurnsInDiagonal(turns, squareWithThis.Coordinates, rightDir);
        AddPossibleTurnsInDiagonal(turns, squareWithThis.Coordinates, leftDir);
